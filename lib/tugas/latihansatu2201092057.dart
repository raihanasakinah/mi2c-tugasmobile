import 'package:coba/tugas/package_mi.dart';
import 'package:coba/tugas/package_tekom.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Latihan | Raihana Sakinah'),
        centerTitle: true,
      ),
      body: Center(
