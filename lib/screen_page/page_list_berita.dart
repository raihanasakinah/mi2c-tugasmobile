import 'package:coba/screen_page/detail_berita.dart';
...
class _PageListBeritaState extends State<PageListBerita> {
  ...
  Future<List<Datum>?> getBerita() async{
    try{
      ...
      http.get(Uri.parse("http://10.126.225.32/beritaDb/getBerita.php"));
                        ...
                        children: [
                          Padding(padding: EdgeInsets.all(4),
                            child: ClipRRect(
                              ...
                              child: Image.network('http://10.126.225.32/beritaDb/gambar_berita/${data?.gambarBerita}',
                                fit: BoxFit.fill,
                              ),
                            ),
                          ),
